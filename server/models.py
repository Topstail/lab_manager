...
class Host(models.Model):
    ip = models.CharField(verbose_name='', max_length=15)
    username = models.CharField(max_length=20)
    password = models.CharField(max_length=50)
    port = models.CharField(max_length=5)
    cpu_name = models.CharField(verbose_name='', max_length=50)
    code_name = models.CharField(verbose_name='', max_length=20, default='')
    cpu_base_clock = models.CharField(verbose_name='', max_length=10, default='')
    disk = models.CharField(verbose_name='', max_length=500)
    hostname = models.CharField(verbose_name='', max_length=20)
    os = models.CharField(verbose_name='', max_length=40)
    bios_version = models.CharField(verbose_name='', max_length=50)
